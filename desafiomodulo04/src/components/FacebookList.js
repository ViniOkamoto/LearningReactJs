...
export default class FacebookFunction extends Component {
  state = {
    posts: [
      {
        id: 1,
      ...
      },
      {
        ...
        date: '04 Jun 2019',
        content:
          'Fala galera, beleza?\nEstou precisando de ajuda em algumas declarações props',
        comments: [
          {
            id: 4,
            author: {
            ...
            date: '04 Jun 2019',
            content:
              'Também estou tendo o mesmo problema. Alguém sabe como solucionar?'
          },
          {
            id: 5,
            author: {
